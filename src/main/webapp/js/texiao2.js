...
$(".nav ul li:eq(3)  ").hover(
		function(){
			$(".nav ul li:eq(3) a ").css("color","#9a0e14")
			$(".nav ol:eq(1)").show();
		},function(){
			$(".nav ol:eq(1)").hide()								 
			$(".nav ul li:eq(3) a ").css("color","#fff") 
		 })
...
$(".nav ul li:eq(0)  ").next().next().hover(
		function(){
			$(".nav ol:eq(2)").show();
            $(".nav ul li:eq(6) a").css("color","#9a0e14"); 
		 },function(){			 
			$(".nav ol:eq(2)").hide()								 
			$(".nav ul li:eq(6) a").css("color","#fff"); 
	 })
...
$(".nav ul li:eq(0)  ").next().next().next().hover(
		 function(){
			 $(".nav ul li:eq(9) a").css("color","#9a0e14");
			 $(".nav ol:eq(3)").show();
		 	},function(){ 
			 $(".nav ol:eq(3)").hide()								
			 $(".nav ul li:eq(9) a").css("color","#fff");				 
		 })
...
$(".nav ul li:eq(0)  ").next().next().next().next().hover(
	 function(){	
		$(".nav ul li:eq(12) a").css("color","#9a0e14");
		$(".nav ol:eq(4)").show();
		},function(){
		$(".nav ol:eq(3)").hide()								 
		$(".nav ul li:eq(12) a").css("color","#fff");						 
})
...
$(".shetuan li:eq(4)").hover(
 ...
 $(".shetuan li:eq(4) a").css("color","#f2980e")
	$(".pingpang	").css("background","url(img/a4.jpg)")},function(){				
