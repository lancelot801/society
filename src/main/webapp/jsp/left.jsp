		...
		<ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
			...
			<li><a href="#systemSetting" class="nav-header collapsed"
				...
				<ul id="systemSetting" class="nav nav-list collapse secondmenu"
					...
					<li><a href="#"><i class="glyphicon glyphicon-eye-open"></i> 活动审核</a></li>
				</ul></li>
			</c:if>	
			<li><a href="#systemSetting2" class="nav-header collapsed"
				...
				<ul id="systemSetting2" class="nav nav-list collapse secondmenu"
					style="height: 0px;">
						<li><a href="<%=request.getContextPath()%>/societyApply/manage?studentId=${userLogin.studentId}"><i class="glyphicon glyphicon-heart"></i> 创办社团</a></li>
						...
						<li><a href="<%=request.getContextPath()%>/student/societyInfo/manage?studentId=${userLogin.studentId}"><i class="glyphicon glyphicon-eye-open"></i> 我的社团</a></li>
				</ul></li>
