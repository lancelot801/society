...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/my_activity_apply.js"></script>
<script type="text/javascript"
...
<body>
<input id="activity_studentId" name="activity_studentId" value="${userLogin.studentId}" style="display: none;">
	<div class="container-fluid">
		<div class="row">
			<%@ include file="/jsp/left.jsp"%>
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">我的活动申请</h1>
