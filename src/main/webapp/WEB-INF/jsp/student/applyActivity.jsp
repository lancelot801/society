					...
					<form class="form-horizontal" id="studentInfoForm"
						...
						<table class="table table-hover table-bordered" style="margin-left: auto;margin-right: auto;">
							...
							<label for="sex"  style="padding-left:10px"
										class="col-sm-2 control-label mylabStyle">活动内容</label>
										<div class="col-sm-10">
							...
							<tr>
								...
								<label for="mobile"  style="padding-left:10px"
										class="col-sm-2 control-label mylabStyle">附件上传</label>
										<div class="col-sm-10">
							...
							<tr>
								<td>
								<div style="display: inline;"><input style="display: inline;" type="file" class="file" name="identityCard2">
								<img id="identityCard2" name="identityCard2" style="width:80px;height:80px" />
								</div>
								</td>
							</tr>
						</table>
