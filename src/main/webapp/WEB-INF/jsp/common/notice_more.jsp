...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/notice_more.js"></script>
<script type="text/javascript"
						...
						<div class="neirong">
							...
							<ul>
								<c:forEach items="${notices}" var="notice">
									<li id="line_u8_0"><a
									href="../common/getNotice?noticeId=${notice.noticeId}"
									title="${notice.theme}" class="clearfix"><span
										class="main-time float_right"><fmt:formatDate value="${notice.publishedTime}" pattern="yyyy年MM月dd日" /> </span>
										${notice.theme}
								</a></li>
